...
body.${BODY_ACTIVE_CLASS}.${BODY_HIDE_NATIVE_CLASS} .app-chrome-panels .panel div.listview-caret-self {
	opacity: 0 !important;
...
body.${BODY_ACTIVE_CLASS}.${BODY_HIDE_NATIVE_CLASS} .app-chrome-panels .panel div.listview-caret-self::before,
body.${BODY_ACTIVE_CLASS}.${BODY_HIDE_NATIVE_CLASS} .app-chrome-panels .panel div.listview-caret-self::after {
	content: none !important;
	opacity: 0 !important;
}

/* The name badge that rides along with the caret. Inline, not layout-bearing. */
body.${BODY_ACTIVE_CLASS}.${BODY_HIDE_NATIVE_CLASS} .app-chrome-panels .panel .text-caret-usertag {
	display: none !important;
}
...
`;
  ...
  var Plugin = class extends AppPlugin {
    ...
    pendingPresetName = "";
    onLoad() {
      pingInstall("cursor-smith");
      pingActive("cursor-smith");
      ...
      void healPluginIdentity(this, {
        ...
        sourceRepo: "https://github.com/akaready/thymer-cursor-smith",
    ...
    _toggleEnabled() {
      ...
      this._renderPanel();
      this._toast(next ? "Cursor Smith on." : "Cursor Smith off.");
    }
    _cyclePreset() {
